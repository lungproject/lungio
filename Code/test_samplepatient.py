...
np.savetxt("../Results/predictvsample.txt",predictvalpetct1 )
...
np.save('../Results/sampleactivations8.npy', activations)
...
activations = model.predict([xpet_val,xct_val,xfuse_val])#W
print(activations.shape)
np.save('../Results/sampleactivations18.npy', activations)